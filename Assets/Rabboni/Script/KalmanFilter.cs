...
public class KalmanFilter
{
    ...
    public void SetAngle(float newAngle) { angle = newAngle; } // Used to set angle, this should be set as the starting angle
    public float GetRate() { return rate; } // Return the unbiased rate

    /* These are used to tune the Kalman filter */
    public void SetQAngle(float newQ_angle) { Q_angle = newQ_angle; }
    public void SetQBias(float newQ_bias) { Q_bias = newQ_bias; }
    public void SetRMeasure(float newR_measure) { R_measure = newR_measure; }

    public float GetQAngle() { return Q_angle; }
    public float GetQBias() { return Q_bias; }
    public float GetRMeasure() { return R_measure; }
